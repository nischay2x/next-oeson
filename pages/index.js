...
export default function Home({ data }) {
  ...
  return (
    <div className="container">
      <Head>
        <title>Home | Oeson</title>
        <meta
          name="description"
          content="We are a remote design company based in Indore, working with clients around the world. As passionate designers, we love building products that are easy to use, accessible, engaging and delightful."
        />
